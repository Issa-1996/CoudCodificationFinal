    ...
    <nav class="header-nav-wrap">
      <ul class="header-nav">
        ...
        <?php if (($_SESSION['profil'] == 'paiement')) { ?>
          ...
          <li class="nav-item">
            <a class="nav-link" href="regularisation" title="Encaissement de caution">Régularisation</a>
          </li>
          <li class="nav-item">
        ...
        <?php
        if (($_SESSION['profil'] == 'message') && isset($_SESSION['classe'])) { ?>
          <li class="nav-item active">
            <a class="nav-link" href="niveau3" title="Changer de niveau de formation">Changer_de_formation</a>
          </li>
        <?php } ?>
        <?php
        if (($_SESSION['profil'] == 'audit') && isset($_SESSION['classe'])) { ?>
          <li class="nav-item active">
            <a class="nav-link" href="niveau2" title="Changer de niveau de formation">Changer_de_formation</a>
          </li>
        <?php } ?>
        ...
        if ($_SESSION['profil'] == 'user' and $_SESSION['type_mdp'] == 'updated') { ?>
          ...
          if (($is_valider_choix != "oui") && ($statutStudentConnect['statut'] == 'Attributaire')) {
            $_SESSION['lit_choisi'] = ''; ?>
            <li class="nav-item active">
...
<section id="homedesigne" class="s-homedesigne">
  <?php if (($_SESSION['profil'] == 'quota') || ($_SESSION['profil'] == ' ') || ($_SESSION['profil'] == 'validation') || ($_SESSION['profil'] == 'chef_residence') || ($_SESSION['profil'] == 'forclusion') || ($_SESSION['profil'] == 'delai') || ($_SESSION['profil'] == 'cs_acp') || ($_SESSION['profil'] == 'dba') || ($_SESSION['profil'] == 'chef_campus') || ($_SESSION['profil'] == 'sag') || ($_SESSION['profil'] == 'chef_departement')  || ($_SESSION['profil'] == 'chef_recette') || ($_SESSION['profil'] == 'pcs') || ($_SESSION['profil'] == 'audit') || ($_SESSION['profil'] == 'message') || ($_SESSION['profil'] == 'paiement')) { ?>
