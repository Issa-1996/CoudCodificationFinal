      ...
      <ul class="header-nav">
        ...
        <?php } ?>
         ...
         <?php if (($_SESSION['profil'] == 'pcs')) { ?>
          <li class="nav-item">
            <a class="nav-link" href="pcs/evolution" title="Evolution">Evolution</a>
          </li>
        <?php } ?>
...
<section id="homedesigne" class="s-homedesigne">
  <?php 
  if (($_SESSION['profil'] == 'quota') || ($_SESSION['profil'] == 'paiement') || ($_SESSION['profil'] == 'validation') || ($_SESSION['profil'] == 'chef_residence') || ($_SESSION['profil'] == 'forclusion') || ($_SESSION['profil'] == 'delai') || ($_SESSION['profil'] == 'cs_acp') || ($_SESSION['profil'] == 'dba') || ($_SESSION['profil'] == 'chef_campus') || ($_SESSION['profil'] == 'sag') || ($_SESSION['profil'] == 'chef_departement') || ($_SESSION['profil'] == 'chef_recette') || ($_SESSION['profil'] == 'pcs') || ($_SESSION['profil'] == 'audit') || ($_SESSION['profil'] == 'message'))  { ?>
