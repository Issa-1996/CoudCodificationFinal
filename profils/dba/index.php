...
$resultats = getLitsBySexeAndNiveau3($sexe1);
    ...
    <div class="container-fluid mt-2">
        ...
        <table class="table table-bordered table-hover" style="font-size:14px;" id="table-to-print">
            ...
            <tbody>
                ...
                ?>
                            <?php
                            $tableau_data_etudiant1 = getAllDatastudentStatus($_GET['quota'], $niveau, $sexe1);
                            ...
                            <tr class="table-primary">
                                ...
                                <td><?= ($niveau); ?></td>
                                <td><a title="VOIRE DETAIL DE LA CLASSE" href="request_suivi.php?classe=<?= $niveau ?>&sexe=<?= $sexe1; ?>" style="color: inherit;">
                                        <?= ($data['sexe']); ?>
                                    </a>
                                </td>
                                <td><?= $comptChoix;
                        ...
                        ?>
                            <?php
                            // print_r($niveau);
                            $tableau_data_etudiant2 = getAllDatastudentStatus($data['sexe'], $niveau, $sexe1);
                            ...
                            <tr class="table-primary">
                                <td><?= ($niveau); ?></td>
                                <td>
                                    <a title="VOIRE DETAIL DE LA CLASSE" href="request_suivi.php?classe=<?= $niveau ?>&sexe=<?= $sexe1; ?>" style="color: inherit;">
                                        <?= ($data['sexe']); ?>
                                    </a>
                                </td>
                                <td><?= $comptChoix2;  ?></td>
