...
$total_lits = getLitOneByNiveau($_SESSION['classe'], $_SESSION['sexe_etudiant']);  //var_dump($total_lits); die;
//}
                ...
                <ul class="options">
                    <form id="myForm" action="traitementCodifier" method="GET">
                        <div class='options-container'>
                            <?php
                            while ($row = mysqli_fetch_array($total_lits)) {
                                if ($counter % 10 == 0) { ?>
                                    <div class='column'>
                                    <?php
                                }
            ...
            <?php } else { ?>
                <div class="row justify-content-center">
                    <div class="col-md-2">
                        ...
                        <button class="btn btn-outline-success fw-bold" type="submit" title="ANNULER LE CHOIX DU LIT CHOISI">ANNULER LE CHOIX </button>
                    </div>
                </div>
            <?php } ?>
            </form>
